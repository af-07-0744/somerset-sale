...
from assessment_comps.match_same_unit_across_buildings.fetch_open_calgary import (
    _extract_subject_unit,
    _normalize_space,
    _strip_unit_tokens,
    _to_float,
)
from city.fetch_subject_street_assessments.sale_config import load_sale_settings
...
DEFAULT_ALL_PROPERTIES_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_all_properties.csv"
)
DEFAULT_CONDO_UNITS_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_condo_units.csv"
)
DEFAULT_PARKING_UNITS_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_parking_units.csv"
)
DEFAULT_STORAGE_UNITS_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_storage_units.csv"
)
DEFAULT_OTHER_PROPERTIES_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_other_properties.csv"
)
DEFAULT_UNIT_LINK_INDEX_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_unit_link_index.csv"
)
DEFAULT_SUBJECT_PROFILE_JSON = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_sale_subject_profile.json"
)
DEFAULT_SUBJECT_PROFILE_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_sale_subject_profile.csv"
)
DEFAULT_BUILDING_SUMMARY_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_building_summary.csv"
)
DEFAULT_SUB_PROPERTY_USE_COUNTS_CSV = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_building_sub_property_use_counts.csv"
)
DEFAULT_SUMMARY_JSON = Path(
    "source/city/build_subject_unit_profile/data/generated/open_calgary_somervale_inventory_summary.json"
)
