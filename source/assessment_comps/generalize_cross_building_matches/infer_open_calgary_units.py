...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--evidence-dir",
        default=str(DEFAULT_INFERENCE_EVIDENCE_DIR),
