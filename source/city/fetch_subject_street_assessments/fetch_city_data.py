...
DEFAULT_OUTPUT_JSON = Path(
    "source/city/fetch_subject_street_assessments/data/generated/open_calgary_somervale_raw_rows.json"
)
DEFAULT_OUTPUT_FLAT_CSV = Path(
    "source/city/fetch_subject_street_assessments/data/generated/open_calgary_somervale_raw_rows_flat.csv"
)
DEFAULT_OUTPUT_META_JSON = Path(
    "source/city/fetch_subject_street_assessments/data/generated/open_calgary_somervale_raw_rows_meta.json"
)
DEFAULT_OUTPUT_FIELD_PROFILE_CSV = Path(
    "source/city/fetch_subject_street_assessments/data/generated/open_calgary_somervale_raw_field_profile.csv"
)
