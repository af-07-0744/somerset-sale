...
DEFAULT_OUTPUT_DIR = Path("source/city/build_building_unit_inventory/city_data")
DEFAULT_INDEX_RST = Path("source/city/build_building_unit_inventory/city_data_index.rst")
DEFAULT_RAW_JSON_PATH = Path(
    "source/city/fetch_subject_street_assessments/data/generated/open_calgary_somervale_raw_rows.json"
)
DEFAULT_FETCH_META_JSON = Path(
