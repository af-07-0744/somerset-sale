...
- Input rows: ``534``
- Fields documented: ``7``
- Last-run fetch/request metadata: :doc:`city_data_fetch_metadata`
...
- Input Flat CSV: :download:`open_calgary_somervale_raw_rows_flat.csv <city_data/_downloads/enums/generated__open_calgary_somervale_raw_rows_flat.csv>`
- Enumeration Dictionary CSV: :download:`open_calgary_street_requested_field_dictionary.csv <city_data/_downloads/enums/generated__open_calgary_street_requested_field_dictionary.csv>`
- Fetch Run Metadata JSON: :download:`open_calgary_somervale_raw_rows_meta.json <city_data/_downloads/enums/generated__open_calgary_somervale_raw_rows_meta.json>`
