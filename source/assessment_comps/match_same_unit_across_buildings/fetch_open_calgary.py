...
DEFAULT_COMPS_RAW = Path(
    "source/assessment_comps/match_same_unit_across_buildings/data/primary/comps_raw.csv"
)
DEFAULT_EVIDENCE_DIR = Path(
    "source/assessment_comps/match_same_unit_across_buildings/data/evidence/open_calgary"
)
